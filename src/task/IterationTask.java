...
public class IterationTask {
    ...
    public IterationTask(int iterCount, Dataset dataset, CuttingStock solver, PermutationCreator permutationCreator) {
    ...
    public IterationTask(int iterCount, int shuffleCount, Dataset dataset, CuttingStock solver, ShufflePermutationCreator shufflePermutationCreator) {
